...
Every time you close a Claude Code window, the insights, Q&As, and lessons from that session disappear. cc-knowledge captures everything, organizes it into a structured vault, and makes it searchable in Obsidian or any Markdown editor.
